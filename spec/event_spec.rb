...
describe Event do
  ...
  # before(:each) do date = DateTime.now.to_date
  ...
  #   event1 = Event.create({description: "Get lunch", location: "work", start_date: '23rd Aug 2013 12:00:00', end_date: '14th Sep 2013 12:00:00'})
  #   event2 = Event.create({description: "Get lunch", location: "work", start_date: '20rd Aug 2015 12:00:00', end_date: '14th Nov 2015 12:00:00'})
  #   event3 = Event.create({description: "Get lunch", location: "work", start_date: '20rd Mar 2012 12:00:00', end_date: '14th Apr 2012 12:00:00'})
